...
import kotlinx.android.synthetic.main.activity_doing_workout2.*
import java.util.*

class DoingWorkout2 : AppCompatActivity() {
    var START_TIME_IN_MILLIS: Long = 300000
    var countDownTimer: CountDownTimer? = null
    var mTimerRunning: Boolean = false
    var mTimeLeftInMillis = START_TIME_IN_MILLIS
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_doing_workout2)
        startTimer()
